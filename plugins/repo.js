...
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
          contextInfo: {
            ...
            externalAdReply: {
              ...
              title: `Arslan-XMD Repo`,
              body: `Check the Arslan-XMD repository!`,
    ...
    const repoUrl = "https://api.github.com/repos/Arslan-MD/Arslan-XMD";
    const headers = {
    ...
    const replyText = `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *${toFancyFont("Arslan-XMD")}* ${toFancyFont("Repo")} 📊
...
│❒ 💥 *${toFancyFont("Powered By Arslan-XMD")}* 🔥
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`;
      ...
      m.from,
      {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            showAdAttribution: true,
            title: `Arslan-XMD Repo`,
            body: `Explore the Arslan-XMD repository!`,
            sourceUrl: "https://github.com/Arslan-MD/Arslan-XMD",
            mediaType: 1,
            renderLargerThumbnail: true,
    ...
    await Matrix.sendMessage(
      m.from,
      {
        ...
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* failed to fetch repo stats! 😈
│❒ Visit: https://github.com/Arslan-MD/Arslan-XMD
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
        contextInfo: {
          mentionedJid: [m.sender],
          externalAdReply: {
            showAdAttribution: true,
            title: `Arslan-XMD Repo`,
            body: `Visit the Arslan-XMD repository!`,
            sourceUrl: "https://github.com/Arslan-MD/Arslan-XMD",
            mediaType: 1,
            renderLargerThumbnail: true,
            mediaUrl: "https://files.catbox.moe/16i1l7.jpg",
