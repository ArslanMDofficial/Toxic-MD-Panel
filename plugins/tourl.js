  ...
  try {
    ...
    if (!m.quoted || !["imageMessage", "videoMessage", "audioMessage"].includes(m.quoted.mtype)) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *Arslan-XMD* needs a quoted image, video, or audio, fam! 📸🎥🎵
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    const { key } = await Matrix.sendMessage(
      m.from,
      { text: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* uploadin’ your media... ${loadingMessages[currentMessageIndex]} 🚀
◈━━━━━━━━━━━━━━━━◈` },
      { quoted: m }
    );
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (mediaType === "audio") {
      await Matrix.sendMessage(
        ...
        {
          text: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* got your audio URL, fam! 🎵
│❒ 🔗 *URL*: ${mediaUrl}
◈━━━━━━━━━━━━━━━━◈`,
        },
        { quoted: m }
      ...
      await Matrix.sendMessage(
        m.from,
        {
          ...
          caption: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* got your ${mediaType} URL, fam! 📸🎥
│❒ 🔗 *URL*: ${mediaUrl}
◈━━━━━━━━━━━━━━━━◈`,
        },
        { quoted: m }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* hit a snag uploadin’, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
