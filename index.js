...
async function startXeonBotInc() {
    ...
    await XeonBotInc.sendMessage(botNumber, {
        text: `*𝐐𝐀𝐃𝐄𝐄𝐑-𝐗𝐃 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘!*
*╭───━━━━───━━━━──┉┈⚆*
...
🔗https://whatsapp.com/channel/0029VbAkAEhCRs1g8MmyEJ2K
   ...
   *_⭐ˢᵗᵃʳ ᵗʰᵉ ʳᵉᵖᵒ_*
🔗https://github.com/QadeerXTech/ARSLAN-MD
╰╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╯`,
        contextInfo: {
            forwardingScore: 1,
            isForwarded: true,
    ...
    console.error('Error sending connection message:', error.message);
            ...
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: QADEERXD`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: QadeerXTech`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: QADEER BRAHVI`))
