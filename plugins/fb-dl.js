  ...
  try {
    ...
    if (!query || !query.startsWith("http")) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, dumbass, gimme a proper *Facebook video URL*! Don’t waste *Arslan-XMD*’s time! 😤📹
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (!data.success || !data.result) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* couldn’t grab that video, fam! URL’s trash or somethin’s busted! 😣
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (!videoUrl) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ No video worth downloadin’ here, fam! *Arslan-XMD* ain’t got time for this shit! 😆
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    const caption = `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* Facebook Video 📹
│❒ 🎬 *Title*: ${title || "No title"}
│❒ 📥 *Quality*: ${quality}
│❒ 💥 Powered By *Arslan-XMD* 🖤
◈━━━━━━━━━━━━━━━━◈`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* fucked up grabbin’ that video, fam! Try again, you got this! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
