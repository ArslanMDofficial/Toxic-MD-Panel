  ...
  try {
    ...
    if (!isCreator) {
      return Matrix.sendMessage(m.from, {
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ Piss off, wannabe! Only *Arslan-XMD* or its boss can update this beast! 😤🔪
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
      }, { quoted: m });
    }
    ...
    const msg = await Matrix.sendMessage(
      m.from,
      { text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* is sniffin’ for updates, fam! Hold tight... 🕵️‍♂️
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈` },
      { quoted: m }
    );
    ...
    const { data: commitData } = await axios.get("https://api.github.com/repos/Arslan-MD/Arslan-XMD/commits/main", {
    ...
    if (!fs.existsSync(packageJsonPath)) {
      await m.React("❌");
      return editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* can’t find package.json, fam! Shit’s broken! 😣
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    }
    ...
    if (latestCommitHash === currentHash) {
      await m.React("✅");
      return editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* is fresh as fuck, fam! No updates needed! 😎🔥
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    }

    await editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ New *Arslan-XMD* update found! Snatchin’ that shit now... 🚀
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    ...
    const response = await axios({
      method: "get",
      url: "https://github.com/Arslan-MD/Arslan-XMD/archive/main.zip",
      responseType: "stream",
    });
    ...
    await editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* is rippin’ open that ZIP, fam... 📦
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    ...
    await editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ Swappin’ out the old shit for new *Arslan-XMD* heat... 🔄
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);

    // Replace files, skip configs
    const sourcePath = path.join(extractPath, "Arslan-XMD-main");
    ...
    await editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* update locked in! Restarting to flex the new shit... ♻️🔥
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    ...
    await Matrix.sendMessage(
      ...
      {
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* fucked up the update, fam! Error: ${error.message} 😈
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
      },
      { quoted: m }
    );
