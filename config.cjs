...
const config = {
  ...
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/16i1l7.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "I Am Arslan-XMD WhatsApp Bot Created by ArslanMD Official",
