...
◈━━━━━━━━━━━━━━━━◈`,
  ...
  try {
    ...
    if (!data.success || !data.result?.download_url) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* couldn’t fetch the Instagram video. API’s actin’ up! 😡
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    await Matrix.sendMessage(m.from, {
      ...
      mimetype: "video/mp4",
      caption: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* dropped your Instagram video! Watch it 📹, fam!
◈━━━━━━━━━━━━━━━━◈`,
      contextInfo: {
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *Arslan-XMD* hit a snag while fetching the Instagram video, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
