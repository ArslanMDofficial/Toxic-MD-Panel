  ...
  try {
    ...
    if (!args[0]) {
      return Matrix.sendMessage(m.from, {
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ Yo, dumbass, gimme a *GitHub username* to stalk! Don’t waste *Arslan-XMD*’s time! 😤💾
...
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
    ...
    if (githubResponse.status !== 200 || !userData.login) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* can’t find that GitHub user, fam! Check the username, clown! 🤡
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
      }, { quoted: m });
    }
...
│❒   🍴 *Forks*: ${repo.forks_count || 0}`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *Arslan-XMD* fucked up stalkin’ that user, fam! Try again or check the name! 😈
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
    }, { quoted: m });
  }
};
